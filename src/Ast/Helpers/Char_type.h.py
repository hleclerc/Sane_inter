...
print "#ifndef CHAR_TYPE_H"
print "#define CHAR_TYPE_H"

print ''
print 'inline unsigned char_type(char c) {'
...
print ''
for t,n in m_char.items(): print '#define CHAR_TYPE_%s %i' % ( t, n );

print ''
print "#endif // CHAR_TYPE_H"
